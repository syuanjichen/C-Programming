/* Compute the check digit of EAN */
...
int main(void)
{
    ...
    printf("Enter the first 12 digits of a European Article Number: ");
    ...
    sum1 = digit_02 + digit_04 + digit_06 + digit_08 + digit_10 + digit_12;
    sum2 = digit_01 + digit_03 + digit_05 + digit_07 + digit_09 + digit_11;
